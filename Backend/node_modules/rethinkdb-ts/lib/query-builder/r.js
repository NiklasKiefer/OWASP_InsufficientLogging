...
const expr = (arg, nestingLevel = globals_1.globals.nestingLevel) => {
    if ((0, query_1.isQuery)(arg)) {
        return arg;
    }
    return (0, query_runner_1.toQuery)((0, param_parser_1.parseParam)(arg, nestingLevel));
};
exports.r = expr;
...
// @ts-ignore
exports.r.deserialize = (termStr) => (0, query_runner_1.toQuery)((0, validate_term_1.validateTerm)(JSON.parse(termStr)));
// @ts-ignore
exports.r.expr = expr;
// @ts-ignore
exports.r.do = (...args) => {
    const last = args.pop();
    return (0, query_1.termBuilder)(query_config_1.funcall, query_runner_1.toQuery)(last, ...args);
};
query_config_1.rConfig.forEach((config) => (exports.r[config[1]] = (0, query_1.termBuilder)(config, query_runner_1.toQuery)));
query_config_1.rConsts.forEach(([type, name]) => (exports.r[name] = (0, query_runner_1.toQuery)([type])));
query_config_1.termConfig
    .filter(([_, name]) => !(name in exports.r))
    .forEach(([type, name, minArgs, maxArgs, optArgs]) => (exports.r[name] = (0, query_1.termBuilder)([
    type,
    name,
    minArgs + 1,
