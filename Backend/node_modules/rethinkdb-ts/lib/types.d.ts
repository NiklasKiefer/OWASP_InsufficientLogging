...
export declare type MultiFieldSelector = RDatum<MultiFieldSelector> | {
    [property: string]: MultiFieldSelector;
} | string | string[] | boolean | number;
export declare type FieldSelector<T, U = any> = string | Func<T, U>;
export declare enum RethinkDBErrorType {
    UNKNOWN = 0,
    API_FAIL = 1,
    CONNECTION = 2,
    MASTER_POOL_FAIL = 3,
...
export interface InsertOptions extends DeleteOptions {
    conflict?: 'error' | 'replace' | 'update' | ((id: RDatum, oldDoc: RDatum, newDoc: RDatum) => RDatum | Record<string, unknown>);
}
...
export interface RCursor<T = any> extends Readable {
    ...
    toArray(): Promise<T[]>;
    close(): Promise<void>;
    each(callback: (err: RethinkDBError | undefined, row: any) => any, onFinishedCallback?: () => any): Promise<any>;
...
export interface RQuery<T = any> {
    ...
    getCursor(connection?: Connection | RunOptions, options?: RunOptions): T extends Array<infer T1> ? Promise<RCursor<T1>> : T extends RCursor<infer T2> ? Promise<T2> : Promise<RCursor<T>>;
}
export interface RDatum<T = any> extends RQuery<T> {
    ...
    <U extends string | number>(attribute: RValue<U>): U extends keyof T ? RDatum<T[U]> : RDatum;
    getField<U extends string | number>(attribute: RValue<U>): U extends keyof T ? RDatum<T[U]> : RDatum;
    nth(attribute: RValue<number>): T extends Array<infer T1> ? RDatum<T1> : never;
    default<U>(value: RValue<U>): RDatum<NonNullable<T> | U>;
    hasFields(...fields: MultiFieldSelector[]): T extends Array<infer T1> ? RDatum<T> : RDatum<boolean>;
    ...
    deleteAt<U>(offset: RValue<number>, endOffset?: RValue<number>): T extends U[] ? RDatum<T> : never;
    ...
    filter<U = T extends Array<infer T1> ? T1 : never>(predicate: DeepPartial<U> | ((doc: RDatum<U>) => RValue), options?: FilterOperatorOptions): this;
    ...
    contains<U = T extends Array<infer T1> ? T1 : never>(val1: any[] | null | string | number | Record<string, unknown> | Func<U>, ...value: Array<any[] | null | string | number | Record<string, unknown> | Func<U>>): T extends Array<infer T1> ? RDatum<boolean> : never;
    ...
    fold<ACC = any, RES = any, ONE = T extends Array<infer T1> ? T1 : never>(base: any, foldFunction: (acc: RDatum<ACC>, next: RDatum<ONE>) => any, // this any is ACC
    options?: {
    ...
    without(...fields: MultiFieldSelector[]): T extends Array<infer T1> ? RDatum<Array<Partial<T1>>> : RDatum<Partial<T>>;
    merge<U = any>(...objects: Array<Record<string, unknown> | RDatum | ((arg: RDatum<T>) => any)>): RDatum<U>;
    innerJoin<U, T2 = T extends Array<infer T1> ? T1 : never>(other: RStream<U> | RValue<U[]>, predicate: (doc1: RDatum<T2>, doc2: RDatum<U>) => RValue<boolean>): RDatum<Array<JoinResult<T2, U>>>;
    outerJoin<U, T2 = T extends Array<infer T1> ? T1 : never>(other: RStream<U> | RValue<U[]>, predicate: (doc1: RDatum<T2>, doc2: RDatum<U>) => RValue<boolean>): RDatum<Array<JoinResult<T2, U>>>;
    eqJoin<U, T2 = T extends Array<infer T1> ? T1 : never>(fieldOrPredicate: RValue<keyof T2> | Func<T2, boolean>, rightTable: RTable<U>, options?: {
        index: string;
    ...
    slice(start: RValue<number>, options?: {
        leftBound?: 'open' | 'closed';
        rightBound?: 'open' | 'closed';
    }): T extends Array<infer T1> ? RDatum<T> : never;
    ...
    coerceTo<U = any>(type: 'object' | 'OBJECT'): T extends Array<infer T1> ? RDatum<U> : never;
    coerceTo(type: 'string' | 'STRING'): RDatum<string>;
    coerceTo(type: 'array' | 'ARRAY'): RDatum<any[]>;
    coerceTo(type: 'number' | 'NUMBER'): T extends string ? RDatum<number> : never;
    coerceTo(type: 'binary' | 'BINARY'): T extends string ? RDatum<Buffer> : never;
    ...
    branch(trueBranch: any, falseBranchOrTest: any, ...branches: any[]): T extends boolean ? RDatum : never;
    and(...bool: Array<RValue<boolean>>): T extends boolean ? RDatum<boolean> : never;
    or(...bool: Array<RValue<boolean>>): T extends boolean ? RDatum<boolean> : never;
...
export interface RStream<T = any> extends RQuery<T[]> {
    ...
    innerJoin<U = any>(other: RStream<U> | RValue<U[]>, predicate: (doc1: RDatum<T>, doc2: RDatum<U>) => RValue<boolean>): RStream<JoinResult<T, U>>;
    outerJoin<U = any>(other: RStream<U> | RValue<U[]>, predicate: (doc1: RDatum<T>, doc2: RDatum<U>) => RValue<boolean>): RStream<JoinResult<T, U>>;
    eqJoin<U = any>(fieldOrPredicate: RValue<keyof T> | Func<T, boolean>, rightTable: RTable<U>, options?: {
        index: string;
    ...
    filter(predicate: DeepPartial<T> | ((doc: RDatum<T>) => RValue), options?: FilterOperatorOptions): this;
    includes(geometry: RDatum): RStream<T>;
    intersects(geometry: RDatum): RStream<T>;
    contains(val1: any[] | null | string | number | Record<string, unknown> | Func<T>, ...value: Array<any[] | null | string | number | Record<string, unknown> | Func<T>>): RDatum<boolean>;
    ...
    fold<ACC = any, RES = any>(base: any, foldFunction: (acc: RDatum<ACC>, next: RDatum<T>) => any, // this any is ACC
    options?: {
    ...
    merge<U = any>(...objects: Array<Record<string, unknown> | RDatum | ((arg: RDatum<T>) => any)>): RStream<U>;
...
export interface RSingleSelection<T = any> extends RDatum<T> {
    update(obj: RValue<DeepPartial<T>> | ((arg: RDatum<T>) => any), options?: UpdateOptions): RDatum<WriteResult<T>>;
    replace(obj: RValue<T> | ((arg: RDatum<T>) => any), options?: UpdateOptions): RDatum<WriteResult<T>>;
...
export interface RTable<T = any> extends RSelection<T> {
    ...
    indexCreate(indexName: RValue<string>, indexFunction?: RDatum | Buffer | RDatum[] | ((row: RDatum) => any), options?: IndexOptions): RDatum<IndexChangeResult>;
...
export interface R {
    ...
    line(point1: [number, number], point2: [number, number], ...points: Array<[number, number]>): RDatum;
    ...
    polygon(ll1: [number, number], ll2: [number, number], ll3: [number, number], ...longitudeLatitudes: Array<[number, number]>): RDatum;
    circle(longitudeLatitude: [number, number] | RDatum, radius: RValue<number>, options?: {
        numVertices?: number;
    ...
    args(arg: RDatum | Array<RValue<Primitives | Record<string, unknown> | any[]>>): any;
    ...
    indexCreate<T>(table: RTable<T>, indexName: RValue<string>, indexFunction?: RDatum | Buffer | RDatum[] | ((row: RDatum) => any), options?: IndexOptions): RDatum<IndexChangeResult>;
    ...
    update<T>(selection: RSelection<T> | RSingleSelection<T>, obj: RValue<DeepPartial<T>> | ((arg: RDatum<T>) => any), options?: UpdateOptions): RDatum<WriteResult<T>>;
    replace<T>(selection: RSelection<T> | RSingleSelection<T>, obj: RValue<T> | ((arg: RDatum<T>) => any), options?: UpdateOptions): RDatum<WriteResult<T>>;
    ...
    innerJoin<T, U>(stream: RStream<T> | RValue<T[]>, other: RStream<U> | RValue<U[]>, predicate: (doc1: RDatum<T>, doc2: RDatum<U>) => RValue<boolean>): RStream<JoinResult<T, U>>;
    outerJoin<T, U>(stream: RStream<T> | RValue<T[]>, other: RStream<U> | RValue<T[]>, predicate: (doc1: RDatum<T>, doc2: RDatum<U>) => RValue<boolean>): RStream<JoinResult<T, U>>;
    eqJoin<T, U = any>(stream: RStream<T> | RValue<T[]>, fieldOrPredicate: RValue<keyof T> | Func<T, boolean>, rightTable: RTable<U>, options?: {
        index: string;
    }): RStream<JoinResult<T, U>>;
    zip<T>(stream: RStream<T>): T extends JoinResult<infer U1, infer U2> ? RStream<U1 & U2> : never;
    union<T, U = T extends Array<infer TArr> ? TArr : T>(stream: RValue<U[]> | RStream<U>, ...other: Array<RStream<U> | RValue<U[]> | {
        interleave: boolean | string;
    }>): RStream<U>;
    union<T, U = T extends Array<infer TArr> ? TArr : T>(stream: RValue<U[]> | RStream<U> | RFeed<U>, ...other: Array<RStream<U> | RValue<U[]> | RFeed<U> | {
        interleave: boolean | string;
    }>): RFeed<U>;
    ...
    hasFields<T>(datum: RDatum<T>, ...fields: MultiFieldSelector[]): T extends Array<infer T1> ? RDatum<T> : RDatum<boolean>;
    filter<T>(feed: RFeed<T>, predicate: DeepPartial<T> | ((doc: RDatum<T>) => RValue), options?: FilterOperatorOptions): RFeed<T>;
    filter<T>(stream: RStream<T>, predicate: DeepPartial<T> | ((doc: RDatum<T>) => RValue), options?: FilterOperatorOptions): RStream<T>;
    filter<T, U = T extends Array<infer T1> ? T1 : never>(datum: RDatum<T>, predicate: DeepPartial<T> | ((doc: RDatum<U>) => RValue), options?: FilterOperatorOptions): RDatum<T>;
    ...
    contains<T, U = T extends Array<infer T1> ? T1 : never>(datum: RDatum<T>, val1: any[] | null | string | number | Record<string, unknown> | Func<U>, ...value: Array<any[] | null | string | number | Record<string, unknown> | Func<U>>): T extends Array<infer T1> ? RDatum<boolean> : never;
    contains<T>(stream: RStream<T>, val1: any[] | null | string | number | Record<string, unknown> | Func<T>, ...value: Array<any[] | null | string | number | Record<string, unknown> | Func<T>>): RDatum<boolean>;
    ...
    orderBy<T, U extends RStream<T>>(stream: U, ...fieldOrIndex: Array<FieldSelector<T> | {
        index: string;
    }>): U;
    ...
    avg<T, U = T extends Array<infer T1> ? T1 : never>(datum: RValue<T>, value?: FieldSelector<U, number | null>): T extends Array<infer T1> ? RDatum<number> : never;
    avg<T>(stream: RStream<T>, value?: RValue<T> | Func<T, number | null>): RDatum<number>;
    min<T, U = T extends Array<infer T1> ? T1 : never>(datum: RValue<T>, value?: FieldSelector<U, number | null>): T extends Array<infer T1> ? RDatum<number> : never;
    min<T>(stream: RStream<T>, value?: RValue<T> | Func<T, number | null> | {
        index: string;
    }): RDatum<number>;
    max<T, U = T extends Array<infer T1> ? T1 : never>(datum: RValue<T>, value?: FieldSelector<U, number | null>): T extends Array<infer T1> ? RDatum<number> : never;
    max<T>(stream: RStream<T>, value?: RValue<T> | Func<T, number | null> | {
        index: string;
    }): RDatum<number>;
    reduce<T, U = any, ONE = T extends Array<infer T1> ? T1 : never>(datum: RValue<T>, reduceFunction: (left: RDatum<ONE>, right: RDatum<ONE>) => any): T extends Array<infer T1> ? RDatum<U> : never;
    reduce<T, U = any>(stream: RStream<T>, reduceFunction: (left: RDatum<T>, right: RDatum<T>) => any): RDatum<U>;
    fold<T, ACC = any, RES = any, ONE = T extends Array<infer T1> ? T1 : never>(datum: RValue<T>, base: any, foldFunction: (acc: RDatum<ACC>, next: RDatum<ONE>) => any, // this any is ACC
    options?: {
        emit?: (acc: RDatum<ACC>, next: RDatum<ONE>, new_acc: RDatum<ACC>) => any[];
        finalEmit?: (acc: RStream) => any[];
    }): T extends Array<infer T1> ? RDatum<RES[]> : never;
    fold<T, ACC = any, RES = any>(feed: RFeed<T>, base: any, foldFunction: (acc: RDatum<ACC>, next: RDatum<T>) => any, // this any is ACC
    options: {
        emit: (acc: RDatum<ACC>, next: RDatum<T>, new_acc: RDatum<ACC>) => any[];
    }): RFeed<RES>;
    fold<T, ACC = any, RES = any>(stream: RStream<T>, base: any, foldFunction: (acc: RDatum<ACC>, next: RDatum<T>) => any, // this any is ACC
    options?: {
        emit?: (acc: RDatum<ACC>, next: RDatum<T>, new_acc: RDatum<ACC>) => any[];
        finalEmit?: (acc: RStream) => any[];
    }): RStream<RES>;
    ...
    merge<U = any>(obj: Record<string, unknown> | RDatum, ...objects: Array<Record<string, unknown> | RDatum | ((arg: RDatum) => any)>): RDatum<U>;
    merge<U = any>(stream: RStream, ...objects: Array<Record<string, unknown> | RDatum | ((arg: RDatum) => any)>): RStream<U>;
    ...
    slice<T extends any[]>(datum: RDatum<T>, start: RValue<number>, end?: RValue<number>, options?: {
        leftBound?: 'open' | 'closed';
        rightBound?: 'open' | 'closed';
    }): RDatum<T>;
    slice<T extends any[]>(datum: RDatum<T>, start: RValue<number>, options?: {
        leftBound?: 'open' | 'closed';
        rightBound?: 'open' | 'closed';
    }): RDatum<T>;
    ...
    do<T extends Primitives | Record<string, unknown>, U>(datum: RValue<T>, ...args: Array<RDatum | Primitives | Record<string, unknown> | ((arg: RDatum<T>, ...args: RDatum[]) => U)>): U extends RStream ? RStream : RDatum;
    ...
    match(datum: RValue<string>, regexp: RValue<string>): RDatum<MatchResults | null>;
    split(datum: RValue<string>, seperator?: RValue<string>, maxSplits?: RValue<number>): RDatum<string[]>;
    upcase(datum: RValue<string>): RDatum<string>;
    downcase(datum: RValue<string>): RDatum<string>;
    add<T extends string | number | Date>(datum: RValue<T>, ...str: Array<RValue<string> | RValue<number>>): RDatum<T>;
    gt<T extends string | number | Date>(datum: RValue<T>, ...value: Array<RValue<string> | RValue<number> | RValue<Date>>): RDatum<boolean>;
    ge<T extends string | number | Date>(datum: RValue<T>, ...value: Array<RValue<string> | RValue<number> | RValue<Date>>): RDatum<boolean>;
    lt<T extends string | number | Date>(datum: RValue<T>, ...value: Array<RValue<string> | RValue<number> | RValue<Date>>): RDatum<boolean>;
    le<T extends string | number | Date>(datum: RValue<T>, ...value: Array<RValue<string> | RValue<number> | RValue<Date>>): RDatum<boolean>;
    sub<T extends number | Date>(datum: RValue<T>, ...num: Array<RValue<number>>): RDatum<T>;
    ...
    branch(datum: RValue<boolean>, trueBranch: any, falseBranchOrTest: any, ...branches: any[]): RDatum;
    ...
    during(datum: RValue<Date>, start: RValue<Date>, end: RValue<Date>, options?: {
        leftBound: 'open' | 'closed';
        rightBound: 'open' | 'closed';
    }): RDatum<boolean>;
